...
void Scene::createScene() {
	...
	Vertex p1Floor(-3.0, 0.0, -5.0);
	Vertex p1Roof(-3.0, 0.0, 5.0);

	Vertex p2Floor(0.0, 6.0, -5.0);
	Vertex p2Roof(0.0, 6.0, 5.0);

	Vertex p3Floor(10.0, 6.0, -5.0);
	Vertex p3Roof(10.0, 6.0, 5.0);

	Vertex p4Floor(13.0, 0.0, -5.0);
	Vertex p4Roof(13.0, 0.0, 5.0);

	Vertex p5Floor(10.0, -6.0, -5.0);
	Vertex p5Roof(10.0, -6.0, 5.0);

	Vertex p6Floor(0.0, -6.0, -5.0);
	Vertex p6Roof(0.0, -6.0, 5.0);

	Vertex MidFloor(5.0, 0.0, -5.0);
	Vertex MidRoof(5.0, 0.0, 5.0);
